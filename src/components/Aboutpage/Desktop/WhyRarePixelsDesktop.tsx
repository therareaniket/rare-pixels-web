...
export default function WhyRarePixelsDesktop() {
    ...
    return (
        <>
            <section className=" section-bg-blue tree-section-desktop">
                <div className="section tree-section-inner">
