...
export default function AboutRpdSectionMobile() {
    ...
    useEffect(() => {
        ...
        const ctx = gsap.context(() => {
            ...
            tl.to(".rpd-mobile-card-wrapper", { scale: 1, y: 0, duration: 1 });
            // tl.to({}, { duration: 0.6 });
            ...
            // tl.to({}, { duration: 0.5 });
            tl.to(".rpd-mobile-card, .rpd-mobile-card-wrapper", { opacity: 0, duration: 0.1 });
            ...
            tl.to(".rpd-mobile-card-1", { x: "0%", opacity: 1, duration: 2 });
            tl.to(".rpd-mobile-card-2", { x: "0%", opacity: 1, duration: 2 });
            tl.to(".rpd-mobile-card-3", { x: "0%", opacity: 1, duration: 2 });
