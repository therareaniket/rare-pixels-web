...
//                     end: "right 50%",
//                     onEnter: () => {
//                         // Only update theme if the section itself is currently pinned/visible
//                         if (theme && ScrollTrigger.isInViewport(section)) {
                ...
                if (i < cards.length - 1) {
                    ...
                    tl.to(
                        nextCard,
                        {
                            ...
                            ease: "none",
                            onStart: () => {
                                if (nextTheme) document.body.setAttribute("data-theme", nextTheme);
                            },
                            onReverseComplete: () => {
                                const currentTheme = card.getAttribute("data-theme-color");
        ...
        <section ref={sectionRef} className="industries-section-sticky section industries-section" style={{ minHeight: "100vh" }}>
            <div className="industirs-section-inner" style={{ height: "100%" }}>
                <div className="container" style={{ height: "100%" }}>
                    ...
                    {/* Fixed Height Container for Absolute Stacking */}
                    <div className="industries-stack-container" style={{ position: "relative", width: "100%", height: "calc(100vh - 120px)", overflow: "hidden" }}>
                        {industries.map((industry, index) => (
                            <div 
                                className="industry-item" 
                                key={index}
