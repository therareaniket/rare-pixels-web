                ...
                <div className="container">
                    ...
                    <Accordion defaultValue={["faq-1"]} className="faq-accordion-wrapper">
                        <div className="accordion-item-wrapper">
                            <span className="accordion-number text-18 text-sb">1</span>
                            <AccordionItem value="faq-1" className="faq-accordion">
                                <AccordionTrigger className="faq-accordion-title"><h3 className="text-16 text-sb text-black">What services does RarePixels offer?</h3></AccordionTrigger>
                        ...
                        <div className="accordion-item-wrapper">
                            <span className="accordion-number text-18 text-sb">2</span>
                            <AccordionItem value="faq-2" className="faq-accordion">
                                <AccordionTrigger className="faq-accordion-title"><h3 className="text-16 text-sb text-black">What industries does RarePixels work with?</h3></AccordionTrigger>
                                <AccordionContent className="faq-content">
                                    <p className="text-14 text-rg text-black">
                        ...
                        <div className="accordion-item-wrapper">
                            <span className="accordion-number text-18 text-sb">3</span>
                            <AccordionItem value="faq-3" className="faq-accordion">
                                <AccordionTrigger className="faq-accordion-title"><h3 className="text-16 text-sb text-black">Why choose RarePixels over other creative agencies?</h3></AccordionTrigger>
                                <AccordionContent className="faq-content">
                                    <p className="text-14 text-rg text-black">
                        ...
                        <div className="accordion-item-wrapper">
                            <span className="accordion-number text-18 text-sb">4</span>
                            <AccordionItem value="faq-4" className="faq-accordion">
                                <AccordionTrigger className="faq-accordion-title"><h3 className="text-16 text-sb text-black">Do you offer both design and development services?</h3></AccordionTrigger>
                                <AccordionContent className="faq-content">
                                    <p className="text-14 text-rg text-black">
                        ...
                        <div className="accordion-item-wrapper">
                            <span className="accordion-number text-18 text-sb">5</span>
                            <AccordionItem value="faq-5" className="faq-accordion">
                                <AccordionTrigger className="faq-accordion-title"><h3 className="text-16 text-sb text-black">Can RarePixels help build a brand from scratch?</h3></AccordionTrigger>
                                <AccordionContent className="faq-content">
                                    <p className="text-14 text-rg text-black">
                        ...
                        <div className="accordion-item-wrapper">
                            <span className="accordion-number text-18 text-sb">6</span>
                            <AccordionItem value="faq-6" className="faq-accordion">
                                <AccordionTrigger className="faq-accordion-title"><h3 className="text-16 text-sb text-black">Do you manage social media for businesses?</h3></AccordionTrigger>
                                <AccordionContent className="faq-content">
                                    <p className="text-14 text-rg text-black">
                        ...
                        <div className="accordion-item-wrapper">
                            <span className="accordion-number text-18 text-sb">7</span>
                            <AccordionItem value="faq-7" className="faq-accordion">
                                <AccordionTrigger className="faq-accordion-title"><h3 className="text-16 text-sb text-black">How do you approach a new project?</h3></AccordionTrigger>
                                <AccordionContent className="faq-content">
                                    <p className="text-14 text-rg text-black">
                        ...
                        <div className="accordion-item-wrapper">
                            <span className="accordion-number text-18 text-sb">8</span>
                            <AccordionItem value="faq-8" className="faq-accordion">
                                <AccordionTrigger className="faq-accordion-title"><h3 className="text-16 text-sb text-black">Can RarePixels redesign an existing website or product?</h3></AccordionTrigger>
                                <AccordionContent className="faq-content">
                                    <p className="text-14 text-rg text-black">
                        ...
                        <div className="accordion-item-wrapper">
                            <span className="accordion-number text-18 text-sb">9</span>
                            <AccordionItem value="faq-9" className="faq-accordion">
                                <AccordionTrigger className="faq-accordion-title"><h3 className="text-16 text-sb text-black">Do you work with businesses outside India?</h3></AccordionTrigger>
                                <AccordionContent className="faq-content">
                                    <p className="text-14 text-rg text-black">
                        ...
                        <div className="accordion-item-wrapper">
                            <span className="accordion-number text-18 text-sb">10</span>
                            <AccordionItem value="faq-10" className="faq-accordion">
                                <AccordionTrigger className="faq-accordion-title"><h3 className="text-16 text-sb text-black">How do I get started with RarePixels?</h3></AccordionTrigger>
                                <AccordionContent className="faq-content">
                                    <p className="text-14 text-rg text-black">
