                    ...
                    <div className="stats-wrapper">
                        <div className="stats-card-row-1">
                            ...
                            <div className="stats-card-2 stats-card">
                                ...
                                <p className="text-upper-case text-white text-18 text-sb">Specialised Solutions Crafted</p>
                                ...
                                <p className="text-18 text-rg text-white">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor.</p>
                            </div>

                            <div className="stats-card-3 stats-card">
                                <h3 className="h1 text-sb text-white">8+</h3>

                                <p className="text-upper-case text-white text-18 text-sb">Industries Transformed Globally</p>
                            ...
                            <div className="stats-card-4 stats-card">
                                ...
                                <p className="text-upper-case text-white text-18 text-sb">Client Trust Retained</p>
                        ...
                        <div className="stats-card-row-2">
                            ...
                            <div className="stats-card-7 stats-card">
                                ...
                                <p className="text-upper-case text-white text-18 text-sb">Projects Delivered With Precision</p>
