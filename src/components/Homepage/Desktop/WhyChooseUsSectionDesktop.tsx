                    ...
                    <div className="container-sm">
                        ...
                        {/* <div className="why-choose-us-tablet">
                            <div className="why-choose-us-image-wrapper">
                                ...
                                {theme === "light" ?
                                    <Image className="" src="/images/homepage/why-choose-us-eclipse-3-res.svg" alt="eclipse" width={625} height={625}></Image>
                                    :
                                ...
                                {theme === "light" ?
                                    <Image className="" src="/images/homepage/why-choose-us-eclipse-9-res.svg" alt="eclipse" width={424} height={424}></Image>
                                    :
