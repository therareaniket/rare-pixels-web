...
export default function ContactWhatHappensSection() {
    ...
    useGSAP(() => {
        ...
        mm.add("(max-width: 1199px)", () => {
            const cards = gsap.utils.toArray<HTMLDivElement>(".cnct-what-happens-pointer-wrapper-tablet");
            ...
            <div className="container">
                ...
                <div ref={tabletWrapperRef} className="cnct-what-happens-pointer-wrapper-tablet">
                    {contactSteps.map((step, index) => {
                        ...
                        return (
                            <div key={step.number} className={`cnct-what-happens-tablet cnct-what-happens-tablet-${index + 1} ${isActive ? "active" : ""}`}>
                                <span className="text-sb">{step.number}</span>
