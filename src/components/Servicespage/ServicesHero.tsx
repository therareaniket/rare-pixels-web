            ...
            <section id="first-section" className="services-hero-section section text-white" style={{ backgroundColor: "black" }}>
                ...
                <div className="services-strip-animation bg-light-black">
                    <div className="services-strip bg-light-black">
                        <h3 className="text-sb">UXUI Design   *  Branding    *    Digital Marketing    *    Development    *    Strategy   *    UXUI Design    *    Branding    *    Digital Marketing    *    Development *    Strategy   *    UXUI Design    *    Branding    *    Digital Marketing    *    Development *    Strategy   *    UXUI Design    *    Branding    *    Digital Marketing    *    Development * UXUI Design   *  Branding    *    Digital Marketing    *    Development    *    Strategy   * </h3>
                    </div>
                </div>
            </section>
        </>
