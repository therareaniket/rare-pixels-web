...
export default function SpeedChart() {
  ...
  useEffect(() => {
    const animationObj = { val: 0 };
    const calculatedDelay = window.innerWidth > 479 ? 3 : 0.2;

    // Set initial opacity to 0 immediately on mount
    ...
    const trigger = ScrollTrigger.create({
      ...
      once: true, // Guarantees it runs only once
      onEnter: () => {
        // Fade in matching the delay and duration
